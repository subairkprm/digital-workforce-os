...
| DEP-007 | TURN/WebRTC infrastructure | Draft reviewed; local runtime selections blocked; implementation unauthorized | Blocks app voice implementation and production calling | Voice/WebRTC + DevOps/SRE | Approved exact contract, pinned local runtime, and bounded evidence; production remains separate |
