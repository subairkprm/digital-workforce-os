...
| DEP-007 | TURN/WebRTC infrastructure | Local coturn design accepted; native licensing and all executable proof open; implementation unauthorized | Blocks app voice implementation and production calling | Voice/WebRTC + DevOps/SRE | Close VBL-04 licensing, authorize implementation separately, then provide bounded executable evidence; production remains separate |
