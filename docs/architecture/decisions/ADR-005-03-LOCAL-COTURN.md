...
STATUS=PROPOSED_RUNTIME_SELECTED_APPROVAL_AND_PROOF_OPEN
...
config and physical-peer Docker/NAT topology are now fixed in
[`../DWCO-0.5-RUNTIME-SELECTION.md`](../DWCO-0.5-RUNTIME-SELECTION.md), but remain DevOps/SRE
approval and executable-proof blockers. Proposed runtime caps are 1 CPU, 256 MiB memory, 100 PIDs,
...
interruption-safe cleanup. Approval of the selected artifact and
proof that these settings work remain pre-code requirements; rendered config, readiness,
